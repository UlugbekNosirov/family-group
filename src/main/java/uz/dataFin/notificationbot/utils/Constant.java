...
public interface Constant {
    ...
    String SEND_ADS_TEXT = "Реклама учун видео ёки расм юборинг.../Отправьте видео или фото для объявления.../Reklama uchun video yoki rasm yuboring...";
    String EDIT_CAPTION = "Ушбу рекламани фойдаланувчиларга юборишни тасдиқлайсизми?/Одобряете ли вы отправку этого объявления пользователям?/Ushbu reklamani foydalanuvchilarga yuborishni tasdiqlaysizmi?";
    String SEND_ADS_200 = "Хабарингиз фойдаланувчиларга етказилди✅/Ваше сообщение доставлено пользователям✅/Xabaringiz foydalanuvchilarga yetkazildi✅";
    String YES = "Ха✅/Да✅/Ha✅";
